...
class GerberExtrude(Operator):
    ...
    bl_label = "Fritzing Gerber post import: extrude"
    ...
    def execute(self, context):
        ...
        importdata.step_name = 'POST_GERBER_CREATE_MATERIAL'
        return {"FINISHED"}
    ...
    for layerClass, layer in svgLayers.items():
        if bpy.context:
            if layerClass == "outline":
                ...
                bpy.ops.mesh.extrude_region_move(MESH_OT_extrude_region={"use_normal_flip":False, "mirror":False}, TRANSFORM_OT_translate={"value":Vector((copperThickness, copperThickness, copperThickness/5))})
                bpy.ops.object.editmode_toggle()
                layer.location.z = boardThickness + copperThickness / 3
                ...
                for obj in layer.objects:
                    obj.location.z = obj.dimensions.z/2 - 0.0001
