...
# 创建集合
collection = bpy.data.collections.new("Resistor_0603")
bpy.context.scene.collection.children.link(collection)

# 创建材质
metal_mat = create_resistor_material("0603_Metal", (0.92, 0.92, 0.92), metallic=0.9, roughness=0.15)
ceramic_mat = create_resistor_material("0603_Ceramic", (0.75, 0.75, 0.75), metallic=0.0, roughness=0.8)
coating_mat = create_resistor_material("0603_Coating", (0.12, 0.12, 0.12), metallic=0.0, roughness=0.95)
...
mesh_coating = bpy.data.meshes.new("0603_Resistor_Coating")
bm_coating.to_mesh(mesh_coating)
obj_coating = bpy.data.objects.new("0603_Resistor_Coating", mesh_coating)
