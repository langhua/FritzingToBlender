...
def create_electrolytic_capacitor_with_horizontal_exposed(size_name='6.3x7.7mm'):
...
# 创建6.3x7.7mm贴片电解电容
collection, dimensions = create_electrolytic_capacitor_with_horizontal_exposed('6.3x7.7mm')

print("贴片电解电容3D模型生成完毕！")
print(f"6.3x7.7mm规格参数：")
