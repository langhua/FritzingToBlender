...
def create_electrolytic_capacitor_with_horizontal_exposed(size_name='5x5.3mm'):
...
# 创建5x5.3mm贴片电解电容
collection, dimensions = create_electrolytic_capacitor_with_horizontal_exposed('5x5.3mm')
