...
def create_electrolytic_capacitor_with_horizontal_exposed(size_name='8x10.3mm'):
...
# 创建8x10.3mm贴片电解电容
collection, dimensions = create_electrolytic_capacitor_with_horizontal_exposed('8x10.3mm')

print("贴片电解电容3D模型生成完毕！")
print(f"8x10.3mm规格参数：")
