...
def create_electrolytic_capacitor_with_horizontal_exposed(size_name='10x10mm'):
...
# 创建10x10mm贴片电解电容
collection, dimensions = create_electrolytic_capacitor_with_horizontal_exposed('10x10mm')
