...
def create_electrolytic_capacitor_with_horizontal_exposed(size_name='12.5x16mm'):
...
# 创建12.5x16mm贴片电解电容
collection, dimensions = create_electrolytic_capacitor_with_horizontal_exposed('12.5x16mm')

print("贴片电解电容3D模型生成完毕！")
print(f"12.5x16mm规格参数：")
