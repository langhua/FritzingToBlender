...
def create_electrolytic_capacitor_with_horizontal_exposed(size_name='3x5.3mm'):
...
# 创建3x5.3mm贴片电解电容
collection, dimensions = create_electrolytic_capacitor_with_horizontal_exposed('3x5.3mm')
