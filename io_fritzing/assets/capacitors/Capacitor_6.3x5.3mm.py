...
# 定义常见贴片电解电容封装尺寸（单位：毫米），包含延伸板水平露出长度类型
ELECTROLYTIC_SIZES = {
...
def create_electrolytic_capacitor_with_horizontal_exposed(size_name='6.3x5.3mm'):
    ...
    # 创建集合
    collection_name = f"Electrolytic_Capacitor_{size_name}_Horizontal_Exposed"
    ...
    print(f"尺寸 {size_name}: 水平露出类型 = {horizontal_exposed_type}, 水平露出长度 = {horizontal_exposed_length}mm")
